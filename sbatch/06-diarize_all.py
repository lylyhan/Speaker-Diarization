...
wav_dir = '/scratch/hh2263/Spokenweb_data/resampled/'
save_dir = '/scratch/hh2263/Spokenweb_data/resampled/stream_3min_score/'
...
script_path = "speakerDiarization_longfiles.py"
